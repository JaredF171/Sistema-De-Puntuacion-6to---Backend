...
from src.app.api.serializers import EventSerializer, EvaluationSerializer, InternHoursSerializer, FeedbackRequestSerializer
from src.app.db.mysql.models import InternHoursModel
from src.app.services.ai_feedback import build_feedback
...
class AIFeedbackController(APIView):
    permission_classes = [IsAuthenticated]
    ...
    def post(self, request):
        ...
        return Response({"status": "success", "data": {"feedback": feedback}})
